...
local Games = {
    ...
    { Name = "TheButton", ID = 107828406309109, Script = "https://raw.githubusercontent.com/ObsidianCatexe/ObsidianCat-Scripts/refs/heads/main/TheButton.lua" },
...
for index, gameData in ipairs(Games) do
    ...
    if gameData.IsUniversal then
        Icon.Image = "rbxassetid://13247071987"
